...
namespace CryptoBacktestingDashboard.Migrations
{
    ...
    [Migration("20260611172016_AddOptimizationTables")]
    partial class AddOptimizationTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CryptoBacktestingDashboard.Models.Crypto.BacktestStrategy", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 6, 11, 19, 20, 15, 350, DateTimeKind.Local).AddTicks(8132),
            ...
            modelBuilder.Entity("CryptoBacktestingDashboard.Models.Crypto.CryptoPair", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BaseAsset = "BTC",
                            CreatedAt = new DateTime(2026, 6, 11, 19, 20, 15, 350, DateTimeKind.Local).AddTicks(7976),
                            CurrentPrice = 60000m,
                            QuoteAsset = "USD",
                            Symbol = "BTC/USD"
                        },
                        new
                        {
                            Id = 2,
                            BaseAsset = "ETH",
                            CreatedAt = new DateTime(2026, 6, 11, 19, 20, 15, 350, DateTimeKind.Local).AddTicks(7980),
                            CurrentPrice = 2000m,
                            QuoteAsset = "USD",
                            Symbol = "ETH/USD"
                        });
            ...
            modelBuilder.Entity("CryptoBacktestingDashboard.Models.Crypto.Indicator", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 6, 11, 19, 20, 15, 350, DateTimeKind.Local).AddTicks(8104),
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 6, 11, 19, 20, 15, 350, DateTimeKind.Local).AddTicks(8108),
